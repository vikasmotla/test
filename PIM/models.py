...
class notification(models.Model):
    ...
    domain = models.CharField(null = False , default = 'System' , choices = DOMAIN_CHOICES , max_length = 3)
...
class blogPost(models.Model):
    ...
    contentFK = models.PositiveIntegerField(null = True) # in case of book or question this will store the ID
